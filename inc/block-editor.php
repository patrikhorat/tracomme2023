...
add_action( 'after_setup_theme', 'tracomme2023_block_editor_setup' );

if ( ! function_exists( 'tracomme2023_block_editor_setup' ) ) {
	 ...
	 * @since 1.0.0
	 */
	function tracomme2023_block_editor_setup() {
		...
		$color_palette = tracomme2023_generate_color_palette();
		if ( $color_palette ) {
...
if ( ! function_exists( 'tracomme2023_generate_color_palette' ) ) {
	/**
	 ...
	 * @return array
	 */
	function tracomme2023_generate_color_palette() {
		$color_palette = array();
		 ...
		 */
		return apply_filters( 'tracomme2023_theme_editor_color_palette', $color_palette );
	}
}
