...
if ( ! function_exists( 'tracomme2023_theme_slug_sanitize_select' ) ) {
	/**
	 * Sanitize select.
	 *
	 * @deprecated 1.2.0 Use tracomme2023_customize_sanitize_select()
	 * @see tracomme2023_customize_sanitize_select()
	 *
	 * @since 0.6.11
	 *
	 ...
	 */
	function tracomme2023_theme_slug_sanitize_select( $input, $setting ) {
		_deprecated_function( __FUNCTION__, '1.2.0', 'tracomme2023_customize_sanitize_select' );
		return tracomme2023_customize_sanitize_select( $input, $setting );
	}
}
...
if ( ! function_exists( 'tracomme2023_adjust_body_class' ) ) {
	 ...
	 */
	function tracomme2023_adjust_body_class( $classes ) {
		_deprecated_function( 'tracomme2023_adjust_body_class', '0.9.4' );
		return $classes;
	}
}

if ( ! function_exists( 'tracomme2023_slbd_count_widgets' ) ) {
	/**
	 ...
	 * @deprecated 0.8.9
	 */
	function tracomme2023_slbd_count_widgets( $sidebar_id ) {

		_deprecated_function( 'tracomme2023_slbd_count_widgets', '0.8.9', 'tracomme2023_widget_classes' );
